...
// names it dispatchAPIStageKey; lives here (alongside the memo) per
// Diego's 2026-06-03 R2 resolution (the key derivation is logically
// the memo's responsibility).
//
